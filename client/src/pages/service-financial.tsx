...
export default function Financial() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 bg-gradient-to-r from-yellow-600 to-yellow-400 text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <Card key={index} className="shadow-lg hover:shadow-xl transition duration-300 border-t-4 border-yellow-600">
